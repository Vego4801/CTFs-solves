...
# Nota: login_token:admjn   =>  perché "admj" rientra nel primo blocco e "n" nel secondo, così
# basta modificare l'IV per sostituire la "j" con "i" e ottenere "admin"!

# Stesso concetto di qualche challenge fa: XOR tra IV e plaintext attuale per ottenere il byte
# del decrypt intermedio; modificare l'IV facendo XOR tra byte di decrypt intermedio e nuovo
# valore da dare al plaintext; il resto è easy, basta seguire cosa fa il programma :D

#               IV                              COOKIE                              1B + PAD
'e34224909d53be8d33b4f46d9b8b4889---950a8939b235969e23bf5af72fd17d3d---27564eb2327ce300f4e5bf4adb0e4319'
'                              8a'
