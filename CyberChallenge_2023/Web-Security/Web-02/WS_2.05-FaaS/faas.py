...
class Faas:
    ...
    def __init__(self, hostname, app_id, wait_token=None, refresh_token=None, debug=True):
        self.app_id = app_id
    ...
    def authorize(self):
        ...
        resp = r.get(url, proxies=self.proxies).json()
    ...
    def get_auth_token(self):
        ...
        resp = r.get(url, proxies=self.proxies)
    ...
    def set(self, key, value):
        ...
        data = {'value': value}
        resp = r.post(url, headers=headers, json=data, proxies=self.proxies)
    ...
    def get(self, key):
        ...
        resp = r.get(url, headers=headers, proxies=self.proxies)
        if resp.status_code == 401:
            print('Invalid auth_token. Check your refresh token')
            return 
...
'''
    ...
    if command == 'get':
        ...
        key = sys.argv[4]
        print('Ok.')
        faas = Faas(hostname, app_id, refresh_token=refresh_token, debug = True)
