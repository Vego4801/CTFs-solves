    ...
    while (1) {
        ...
        switch (option) {
            case 1:
                ...
                if (chunks[idx] > limit) {      // NOTE: This prevents to allocate a chunk outside the top_chunk.
            ...
            case 4:
                ...
                chunks[idx][len] = 0;       // NOTE: If len == sizes[idx], this will write a null byte at the end.
                break;
            default:
                puts("invalid option");
                break;
